export const products = [
    ...
    },
    {
      ...
      price: 600,
      description: "Una de las salsas más conocidas, gracias a su combinación de frescura, dulzor y acidez moderada. Originaria de la cocina China y oriental. Ideal para Carnes, Pastas, Arroz y frituras.",
      category: 1
    },
    {
      id: 3,
      ...
      price: 1400,
      description: "Es ideal para acompañar comidas tanto orientales como occidentales ya sean verduras fritas, arroz, empanizados, al igual que sopas, incluso algunas gotas agregadas a aderezos de ensaladas, además también puede ser incluida con las carnes ya que su sabor es ideal para marinarlas o freírlas como pescado, pollo, res, cerdo etc. Es un condimento salado, pero con un toque dulce.",
      category: 1
    },
    {
      id: 4,
      ...
      price: 300,
      description: "Arroz ideal para preparar sushi. Alimento rico y saludable.",
      category: 2
    },
    {
      id: 5,
      ...
      price: 300,
      description: "Arroz ideal para preparar sushi. Alimento rico y saludable. Envase por 30kg.",
      category: 2
    },
    {
      id: 6,
